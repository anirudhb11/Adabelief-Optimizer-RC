...
parser.add_argument('--dist-url', default='tcp://127.0.0.1:9696', type=str,
...
parser.add_argument('--run_number', default=1, type=int, help='run number')
...
def main():
    ...
    print('the number of GPUs are: ', ngpus_per_node)
...
def main_worker(gpu, ngpus_per_node, args):
    filename = 'model-{}-optimizer-{}-lr-{}-epochs-{}-decay-epoch-{}-eps{}-beta1{}-beta2{}-centralize-{}-reset{}-start-epoch-{}-l2-decay{}-l1-decay{}-batch-{}-warmup-{}-fixed-decay-{}-distributed-{}'.format(args.arch, args.optimizer, args.lr, args.epochs, args.when, args.eps, args.beta1, args.beta2, args.centralize, args.reset, args.start_epoch, args.weight_decay, args.l1_decay, args.batch_size, args.warmup, args.fixed_decay, args.multiprocessing_distributed)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # if i==999:
            ...
            # print("Total time for 1000 iterations:",main_time_end-main_time_start)
            # sys.exit()
